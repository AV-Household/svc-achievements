...
namespace Achievements.Specs.Features
{
    ...
    public partial class АвтоматическийПодсчетРейтингаРебенкаFeature : object, Xunit.IClassFixture<АвтоматическийПодсчетРейтингаРебенкаFeature.FixtureData>, System.IDisposable
    {
...
#line hidden
        ...
        public АвтоматическийПодсчетРейтингаРебенкаFeature(АвтоматическийПодсчетРейтингаРебенкаFeature.FixtureData fixtureData, Achievements_Specs_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Изменеие рейтинга при выполнении ребенком задачи")]
        [Xunit.TraitAttribute("FeatureTitle", "Автоматический подсчет рейтинга ребенка")]
        [Xunit.TraitAttribute("Description", "Изменеие рейтинга при выполнении ребенком задачи")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Изменеие рейтинга при невыполнении ребенком задачи в срок")]
        [Xunit.TraitAttribute("FeatureTitle", "Автоматический подсчет рейтинга ребенка")]
        [Xunit.TraitAttribute("Description", "Изменеие рейтинга при невыполнении ребенком задачи в срок")]
...
#line hidden
#line 37
  testRunner.When("Пришло сообщение, что Сын не_выполнил задачу", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Изменеие рейтинга при покупке приза")]
        [Xunit.TraitAttribute("FeatureTitle", "Автоматический подсчет рейтинга ребенка")]
        [Xunit.TraitAttribute("Description", "Изменеие рейтинга при покупке приза")]
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                АвтоматическийПодсчетРейтингаРебенкаFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                АвтоматическийПодсчетРейтингаРебенкаFeature.FeatureTearDown();
            }
        }
    }
}
